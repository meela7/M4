...
<title> M4 - Metadata Management System for Environmental Monitoring & Management </title>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="" class="dropdown-toggle"
						...
						<ul class="dropdown-menu inverse">				
							...
							<li><a href="#instrument-list"> Instrument</a></li>
							<li><a href="#prediction-list"> Prediction</a></li>
