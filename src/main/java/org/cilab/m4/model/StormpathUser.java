...
public class StormpathUser {
    ...
    String email;
    String groupUrl;
//    List<Toot> tootList; //what could user have for WISE application?
    Account account;

    public StormpathUser() {
    }

    public StormpathUser(StormpathUser user) {
        if (user != null) {
...
//            setTootList(user.getTootList());
    ...
    public StormpathUser(Account account) {
        if (account != null) {
